        ...
        <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-8'>
            <div className='md:w-11/12 mx-auto flex flex-col md:flex-row justify-between items-center gap-12'>
                ...
                <div className='md:w-3/5 mx-auto'>
                    ...
                    <p className='md:w-3/4 text-white mb-8 tracking-wider'>
        ...
        <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto py-16'>
            <div className='flex flex-col md:flex-row justify-between items-center gap-8'>
                <div className='md:w-1/2'>
                    ...
                    <h2 className='text-4xl text-black mb-4 md:w-4/5 tracking-wide font-bold'>Embarking on a <span className='text-steelBlue'>journey of innovation and excellence.</span></h2>
