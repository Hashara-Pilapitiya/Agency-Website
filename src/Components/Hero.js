            ...
            <Carousel className='w-full mx-auto'>
                ...
                <div className="my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-12">
                    ...
                    <div className='md:w-1/2'>
                        ...
                        <p className='text-white text-base tracking-wide mb-8'>Where to grow your business as a photographer:site or social media?</p>

                        <button className='px-7 py-2 bg-steelBlue text-black font-bold rounded hover:bg-silver transition-all duration-300 hover:-translate-y-4'><span className='hover:tracking-wide'>Register</span></button>
                    </div>
                </div>
                ...
                <div className="my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-10">
                    ...
                    <div className='md:w-1/2'>
                        ...
                        <p className='text-white text-base tracking-wide mb-8'>At our agency, creativity knows no bounds. We bring visions to life through stunning designs and imaginative concepts. </p>

                        <button className='px-7 py-2 bg-steelBlue font-bold text-black rounded hover:bg-silver transition-all duration-300 hover:-translate-y-4'><span className='hover:tracking-wide'>Register</span></button>
                    </div>
                </div>
                ...
                <div className="my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-10">
                    ...
                    <div className='md:w-1/2'>
                        ...
                        <p className='text-white text-base tracking-wide mb-8'>Our consultancy goes beyond advice; we partner with you on your journey to success.  </p>
                ...
                <div className="my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-10">
                    ...
                    <div className='md:w-1/2'>
                        ...
                        <p className='text-white text-base tracking-wide mb-8'>We are more than an agency; we are storytellers through strategic marketing and compelling advertising.  </p>
